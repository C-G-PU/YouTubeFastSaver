...
class BrowserWindow(QMainWindow):
    ...
    def save_cookies(self):
        ...
        # We need to intercept cookies as they are loaded or added
        # Fortunately, QWebEngineCookieStore has a cookieAdded signal
        self._cookie_added_conn = cookie_store.cookieAdded.connect(self.on_cookie_added)

        # Trigger saving after a short delay to allow cookies to load
        from PyQt6.QtCore import QTimer
        QTimer.singleShot(2000, self.write_cookies_to_file)
    ...
    def write_cookies_to_file(self):
        try:
            ...
            # Disconnect to avoid memory leaks/multiple triggers
            try:
